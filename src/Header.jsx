    ...
    <div className="sticky top-0 z-50 bg-white shadow-sm w-full">
      ...
      <div className="border-t border-gray-100 bg-white">
        <div className="container mx-auto px-4">
            ...
            {/* Dropdown Button Area - Added 'group' class for desktop hover */}
            <div className="w-full lg:w-auto py-2 lg:py-0 group" ref={catMenuRef}>
                ...
                {/* Dropdown Menu - Added 'md:group-hover:block' for desktop hover */}
                <div className={`${showCategories ? 'block' : 'hidden'} md:group-hover:block absolute top-full left-0 w-full lg:w-64 bg-white border border-gray-200 shadow-xl rounded-xl pt-2 pb-2 mt-1 z-50`}>
